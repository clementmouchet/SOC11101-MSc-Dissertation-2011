...
function getType(sProfileCategory, productType, brand, modelName, modelNumber, category) {
	...
	// it performs the Ajax request to the php script oDataItem.php in the same way than the (GET) described above and append the "options Object" returned in JSON to the select
...
function getDevice(sProfileCategory, device, rating) {
    //alert("oDataItem.php?sProfileCategory=" + sProfileCategory + "&device=" + device + "&rating=" + rating);
    if (sProfileCategory != "") {
        $("#device").ajaxAddOption("oDataItem.php", {
            sProfileCategory: sProfileCategory,
            device: device,
            rating: rating
        },
...
function getRating(sProfileCategory, device, rating) {
    //alert("oDataItem.php?sProfileCategory=" + sProfileCategory + "&device=" + device + "&rating=" + rating);
    if (sProfileCategory != "") {
        $("#rating").ajaxAddOption("oDataItem.php", {
            sProfileCategory: sProfileCategory,
            device: device,
            rating: rating
        },
