            ...
            <div id="main">
                ...
                <div id="right" class="">
                    <div id="top_right" class="shadow corners">
                        ...
                        <div style="clear:both"></div>
                        <div id="chartbtns">
                            <input type="button" name="all" value="All Equipment" id="btn_all_equipment" onclick="allEquipment()">
                            <input type="button" name="categorized" value="By categories" id="btn_by_category" onclick="byCategory()">
                        </div>
                    </div>
                    <div style="clear:both"></div>
