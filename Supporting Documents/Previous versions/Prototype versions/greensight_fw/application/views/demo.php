...
<html lang="en-EN">
    <head>
        ...
        <script src="http://localhost/~Clement/greensight_fw/javascript/jquery.selectboxes.min.js" type="text/javascript" charset="utf-8">
</script>
        <script src="http://localhost/~Clement/greensight_fw/javascript/jquery.selectboxes.pack.js" type="text/javascript" charset="utf-8">
</script>
        <script src="http://localhost/~Clement/greensight_fw/javascript/calculator.js" type="text/javascript" charset="utf-8">
</script>
        <script src="http://localhost/~Clement/greensight_fw/javascript/jquery.OnEnter.js" type="text/javascript" charset="utf-8">
</script>
    </head>
    <body>
        <h1 id="titl">
