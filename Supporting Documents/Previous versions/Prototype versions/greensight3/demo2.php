...
<html lang="en-EN">
    ...
    <body>
        ...
        <div id="dcalclulator" class="shadow corners">
            ...
            <input type="text" name="quantity" value="1" id="quantity" style="display:none" onenter="getFooprint($(productType).val(),$(brand).val(),$(modelName).val(), $(modelNumber).val(),$(category).val(), $(this).val())"><br>
            <input type="button" name="reset" value="reset" id="reset" onclick="resetCalc()"><input type="button" name="submit" value="submit" id="submit" onclick="getFooprint($(productType).val(),$(brand).val(),$(modelName).val(), $(modelNumber).val(),$(category).val(), $(this).val())">
            <div id="dresults">
