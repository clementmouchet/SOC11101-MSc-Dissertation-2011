...
function pickSelect(sProfileCategory, productType, brand, modelName, modelNumber, category, device, rating) {
    ...
    //alert("oDataItemOptions.php?sProfileCategory=" + sProfileCategory + "&productType=" + productType + "&brand=" + brand + "&modelName=" + modelName + "&modelNumber=" + modelNumber + "&category=" + category);
    $.get('drillOption.php', {
    ...
    function(sdrillOption) {
        ...
        case "rating":
            ...
            break;
        default:
            setQuantity(sProfileCategory, productType, brand, modelName, modelNumber, category, device, rating, quantity);
        }
    });
};
...
function getModels(sProfileCategory, productType, brand, modelName, modelNumber, category) {
    //alert("oDataItemOptions.php?productType=" + productType + "&brand=" + brand + "&modelName=" + modelName + "&modelNumber=" + modelNumber + "&category=" + category);
    if ((productType != "" & brand != "") || (productType == "" & brand != "")) {
...
function getDevice(sProfileCategory, device, rating) {
    //alert("oDataItemOptions.php?sProfileCategory=" + sProfileCategory + "&device=" + device + "&rating=" + rating);
    if (sProfileCategory != "") {
...
function getFooprint(sProfileCategory, productType, brand, modelName, modelNumber, category, device, rating, quantity) {
    ...
    //alert(sProfileCategory + " " + productType + " " + brand + " " + modelName + " " + modelNumber + " " + category + " " + quantity + " " + device + " " + rating);
    $.get('oProfile.php', {
        sProfileCategory: sProfileCategory,
        productType: productType,
        brand: brand,
